...
/opt/cuda/8.0/bin/nvcc tf_sampling_g.cu -o tf_sampling_g.cu.o -c -O2 -DGOOGLE_CUDA=1 -x cu -Xcompiler -fPIC
...
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I $HOME/anaconda3/envs/py2.7-tf1.2/lib/python2.7/site-packages/tensorflow/include -I /opt/cuda/8.0/include -lcudart -L /opt/cuda/8.0/lib64/ -O2 -D_GLIBCXX_USE_CXX11_ABI=0
